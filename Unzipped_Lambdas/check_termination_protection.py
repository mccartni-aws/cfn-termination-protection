...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    if configuration_item['supplementaryConfiguration']['EnableTerminationProtection'] is True:
        return build_evaluation_from_config_item(configuration_item, 'COMPLIANT')
    return build_evaluation_from_config_item(configuration_item, 'NON_COMPLIANT', annotation='This CloudFormation Stack does not have termination protection enabled.')
